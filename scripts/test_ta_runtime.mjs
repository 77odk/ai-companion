...
group('H. Chat / Home 一致性')
{
  ...
  ok(zhCtx.includes('【你自己此刻在做什么】') && zhCtx.includes('你（TA）自己当前的生活状态') && zhCtx.includes('绝不要把这件事写成对方在做') && zhCtx.includes('预计会持续到 22:30 左右'), 'H34 zh context 明确属于 TA 自己、禁止说成对方的事')
