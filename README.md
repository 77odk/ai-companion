...
忆文（Eluvin）采用 [PolyForm Noncommercial 1.0.0](https://polyformproject.org/licenses/noncommercial/1.0.0) 授权：可以看、可以借鉴、可以拿去改、可以分享，不能商用。

- 可以借鉴：读源码、看思路、拿去改成自己的东西、自己跑起来用
- 可以分享：把改过的版本发给别人，只要同样不涉及赚钱
- 必须署名：无论借鉴、修改还是再分享，都必须写明来源（忆文 Eluvin · github.com/77odk/ai-companion），并且不得抹掉版权声明与署名。分享给别人时请带上本节或指向本仓库的链接
- 不可商用：售卖、接单、打包进收费产品、放进自家商业服务里
